 ...
 * @element custom-hax-polaris-theme
 */
class CustomHaxPolarisTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
   ...
   */
  static get tag() {
    return "custom-hax-polaris-theme";
  }
...
customElements.define(CustomHaxPolarisTheme.tag, CustomHaxPolarisTheme);
export { CustomHaxPolarisTheme };
