 ...
 * @element polaris-yellow-theme
 */
class PolarisYellowTheme extends LTIResizingMixin(
    ...
    return [
      ...
      css`
        ...
        :host([is-safari]) {
          ...
          --polaris-nav-bg-color: var(--ddd-theme-default-roarGolden);
        }
...
customElements.define(PolarisYellowTheme.tag, PolarisYellowTheme);
export { PolarisYellowTheme };
