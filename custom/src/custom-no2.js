...
/**
 * `CustomPolTheme`
 * `CustomPolTheme based on modern flex design system`
 ...
 * @element custom-pol-theme
 */
class CustomPolTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomPolTheme.tag, CustomPolTheme);
export { CustomPolTheme };
